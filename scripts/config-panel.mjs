...
const TABS = [
  ...
  { id: "actions",    label: "Combat Actions",     icon: "fa-solid fa-person-running",
    settings: ["raw3dDistance", "criticalFumbleEnabled", "rangedInMeleeDisadvantage", "opportunityAttackPrompt", "opportunityAttackReach", "riderPromptsFollowRoller", "enforceLoadout"] },
