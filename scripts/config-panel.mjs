...
const TABS = [
  ...
  { id: "saves",      label: "Saves",              icon: "fa-solid fa-shield-heart",
    settings: ["targetStateAssessment", "autoRollNpcSaves", "concentrationTracking", "concentrationWidget", "concentrationOnDamage", "concentrationDamageMinDC", "bonusActionSpellRule", "bonusActionSpellStrict"] },
  ...
  { id: "templates",  label: "Templates",          icon: "fa-solid fa-circle-dot",
    settings: ["enforceSquareCubes", "spellDifficultTerrain", "autoTargetTemplates", "autoDeleteInstantTemplates", "excludeCasterFromTemplates", "hideSpellTemplateVisuals"] },
  ...
  { id: "actions",    label: "Combat Actions",     icon: "fa-solid fa-person-running",
    settings: ["raw3dDistance", "lockRestrainedMovement", "criticalFumbleEnabled", "rangedInMeleeDisadvantage", "opportunityAttackPrompt", "opportunityAttackReach", "riderPromptsFollowRoller", "enforceLoadout"] },
  ...
  { id: "initiative", label: "Initiative",         icon: "fa-solid fa-hourglass-start",
    settings: ["showInitiativeButtons", "pcInitiativeAutoRoll", "hideNpcInitiative"] },
