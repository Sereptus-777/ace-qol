...
const TABS = [
  ...
  { id: "attacks",    label: "Attacks",            icon: "fa-solid fa-swords",
    settings: ["damageTypeSeparation", "autoCheckResistances", "slayerAutoDetect", "batchResultsCard", "dualWielderGrantsOffhandMod", "pactBladePromptPerAttack"] },
  ...
  { id: "saves",      label: "Saves",              icon: "fa-solid fa-shield-heart",
    settings: ["targetStateAssessment", "autoRollNpcSaves", "concentrationTracking", "concentrationOnDamage", "concentrationDamageMinDC", "unifyConcentrationMarker", "bonusActionSpellRule", "bonusActionSpellStrict"] },
  ...
  { id: "actions",    label: "Combat Actions",     icon: "fa-solid fa-person-running",
    settings: ["raw3dDistance", "lockRestrainedMovement", "criticalFumbleEnabled", "fumbleEndsTurn", "rangedInMeleeDisadvantage", "opportunityAttackPrompt", "opportunityAttackReach", "riderPromptsFollowRoller", "enforceLoadout", "blockUnequippedAttack"] },
  { id: "masteries",  label: "Weapon Masteries",   icon: "fa-solid fa-khanda",
    settings: ["weaponMasteryEnabled", "weaponMasteryStrict", "weaponMasteryAllowIn2014", "cleaveRawAttackRoll"] },
  { id: "initiative", label: "Initiative",         icon: "fa-solid fa-hourglass-start",
    settings: ["showInitiativeButtons", "pcInitiativeAutoRoll", "hideNpcInitiative", "playerCanStartCombat"] },
  { id: "loot",       label: "Loot",               icon: "fa-solid fa-treasure-chest",
    settings: ["enableLootGeneration", "lootOnBio", "lootOnDeath", "minCRForLoot", "maxTotalLoot", "lootCardPublic", "autoPostLootCard", "beastsCarryLoot"] },
  ...
  { id: "ui",         label: "UI / Cards",         icon: "fa-solid fa-window-maximize",
    settings: ["suppressSystemCards", "hideSaveDC", "hideNPCNames", "playersSeeBloodied", "tooltipDelay"] },
  { id: "advanced",   label: "Advanced",           icon: "fa-solid fa-screwdriver-wrench",
    settings: ["enableFlagsSystem", "enableOptionalPrompts", "midiCompatibility", "enableOnUseHooks", "enableOverTimeEffects", "autoApplyOverTimeDamage", "enableSpeedRolls", "enableMergeCard", "debugMode", "situationalNarration"] },
