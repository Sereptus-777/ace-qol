...
// RAW is "1 primary target + 3 secondaries within 30 ft of primary." Without
...
// in 150 ft saves) both misrepresent the spell. The current dnd5e + save-
...
export const CHAIN_SPELLS = {
  ...
  // ── Catapult (1st, S, 60 ft, single target) ─────────────────────────────
  // Hurl a 5-lb object at a creature within 60 ft. Target takes 3d8
 ...
 *     // Primary picker UI: 1 target within 150 ft.
 *     // ChainResolver auto-picks up to 3 secondaries within 30 ft of primary,
 *     // skips invalid (caster, objects, dead). Each rolls own save.
 *     primaryRange: 150,
 *     secondaryRangeFromPrimary: 30,
 *     secondaryCount: 3,
 *     picker: { allowSelf: false, excludeDead: true },
 *     flavorOnConfirm: "A bolt of lightning leaps to a primary target — DEX save vs 10d8 lightning, half on success. Three secondaries within 30 ft each save separately.",
 *   },
 */
