...
export const TRIGGER_SPELLS = {
  ...
  // ── Spike Growth (2nd, V·S·M, 150 feet, 20 feet sq, 10 min, conc.) ──────────
  // 2d4 piercing per 5 feet moved through (no save). Difficult terrain.
  // spell-timing has timing: NO_SAVE_AUTO + difficultTerrain: 2.
  "spike growth": {
    shape: "template-trigger",
    range: 150,
    save: null,
    flavorOnConfirm: "Hard spikes erupt across the 20-ft area — 2d4 piercing per 5 feet of movement, no save. Difficult terrain.",
  },

  // ── Cloud of Daggers (2nd, V·S·M, 60 feet, 5 feet cube, 1 min, conc.) ───────
  ...
  // ── Wall of Fire (4th, V·S·M, 120 feet, 60 feet × 20 feet, 1 min, conc.) ──────
  ...
  // ── Wall of Stone (5th, V·S·M, 120 feet, ten 10×10 panels, 10 min, conc.) ─
  ...
  // ── Moonbeam (2nd, V·S·M, 120 feet, 5 feet × 40 feet cylinder, 1 min, conc.) ──
  // 2d10 radiant damage, CON save half. Shapechangers have disadvantage AND
  // revert on fail. Moves 60 feet as caster action.
  "moonbeam": {
    shape: "template-trigger",
    range: 120,
  ...
  // ── Grease (1st, V·S·M, 60 feet, 10 feet square, 1 min) ─────────────────────
  ...
  // ── Web (2nd, V·S·M, 60 feet, 20 feet cube, 1 hour, conc.) ──────────────────
  ...
  // ── Evard's Black Tentacles (4th, V·S·M, 90 feet, 20 feet sq, 1 min, conc.) ─
